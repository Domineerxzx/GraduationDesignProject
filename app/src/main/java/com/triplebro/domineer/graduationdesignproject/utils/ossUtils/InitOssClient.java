package com.triplebro.domineer.graduationdesignproject.utils.ossUtils;
...
import com.triplebro.domineer.graduationdesignproject.beans.OssBean;
    ...
    public static void initOssClient(final Context context, String tokenAddress, final String endPoint) {
        ...
        HttpUtils.sendOkHttpRequest(tokenAddress, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                Gson gson = new Gson();
                OssBean ossBean = gson.fromJson(response.body().string(), OssBean.class);
