...
public class SearchActivity extends Activity implements View.OnClickListener, TextWatcher, AdapterView.OnItemClickListener {
    ...
    private RecommendAdapter searchResultAdapter;
    private RecommendAdapter recommendAdapter;
    private List<CommodityInfo> commodityRecommendInfoList;
    ...
    private void initData() {
        ...
        commodityRecommendInfoList = searchManager.getCommodityRecommendInfoList();
        recommendAdapter = new RecommendAdapter(this, commodityRecommendInfoList);
        rv_recommend_search.setAdapter(recommendAdapter);
        ...
        recommendAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                intent.putExtra("commodityInfo", commodityRecommendInfoList.get(position));
    ...
    public void afterTextChanged(final Editable s) {
        if (s.length() > 0) {
            final List<CommodityInfo> searchInfoList = searchManager.searchInfoList(s.toString().trim());
            if (searchInfoList.size() != 0) {
                ...
                searchResultAdapter.setOnItemClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        Intent intent = new Intent(SearchActivity.this, CommodityDetailsActivity.class);
                        intent.putExtra("commodityInfo", searchInfoList.get(position));
                        startActivity(intent);
                    }
