...
public class MyOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        //商品表
        db.execSQL("create table commodityInfo(commodity_id Integer primary key autoincrement,commodity_name varchar(20),price number,commodity_image varchar(200)," +
        ...
        //商品图片表
        db.execSQL("create table commodityImageInfo(_id Integer primary key autoincrement,commodity_id Integer,commodity_image varchar(200),phone_number varchar(20)," +
                "FOREIGN KEY (commodity_id) REFERENCES commodityInfo(commodity_id)," +
                "FOREIGN KEY (phone_number) REFERENCES adminInfo(phone_number))");
        //商品尺码/库存表
        db.execSQL("create table commoditySizeInfo(_id Integer primary key autoincrement,commodity_id Integer,size_name varchar(20),size_count number,phone_number varchar(20)," +
                "FOREIGN KEY (commodity_id) REFERENCES commodityInfo(commodity_id)," +
                "FOREIGN KEY (phone_number) REFERENCES adminInfo(phone_number))");
        ...
        //收藏商品表
        db.execSQL("create table collectionCommodityInfo(_id Integer primary key autoincrement,phone_number varchar(20),commodity_id Integer," +
                "FOREIGN KEY (phone_number) REFERENCES userInfo(phone_number)," +
                "FOREIGN KEY (commodity_id) REFERENCES commodityInfo(commodity_id))");
        //收藏发现表
